 ...
 */
class getMonstersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MonstersRepository' shared autowired service.
     *
     * @return \App\Repository\MonstersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MonstersRepository.php';

        return $container->privates['App\\Repository\\MonstersRepository'] = new \App\Repository\MonstersRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
